...
<head>
    ...
    <title>Blogs || Online Rental Agreement</title>
    <?php
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section
            ...
            <div class="container">
                <div
                    ...
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Blogs</h1>
        ...
        <section class="blog-standard-area py-4 rpy-100">
            <div class="container py-2">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="blog-standard-wrap">
                            <div class="blog-standard-item" data-aos="fade-up" data-aos-duration="1500"
                                data-aos-offset="50">
                                <div class="image">
                                ...
                                <div class="content">
                                    <ul class="blog-meta">
                                        ...
                                        <li><img src="assets/images/blog/author.png" alt="Author"> <a
                                                href="#">Matthew</a></li>
                                        <li><i class="far fa-calendar-alt"></i> <a href="#">September 20, 2023</a></li>
                                    </ul>
                                    <h3><a href="blog-details.html">Achieving Fashion Elegant Design Runway Life</a>
                                    </h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus sit voluptatem accusantium doloremque
                                        laudantium eaque ipsa quae abillo inventore veritatis et quasi architecto beatae
                                    </p>
                                    <a href="blog-details.html" class="theme-btn style-two">Read More <i
                                            class="far fa-arrow-right"></i></a>
                                </div>
                            </div>
                            <blockquote class="blockquote-three bgc-lighter mb-50" data-aos="fade-up"
                                data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                                <div class="text">Remote work made easy way better tools Section Bonorum et Malorum
                                </div>
                            ...
                            <blockquote class="blockquote-three bgc-primary text-white mb-50" data-aos="fade-up"
                                data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                                <div class="text">Remote work made easy way better tools Section Bonorum et Malorum
                                </div>
                                <h5 class="name">Michael A. Jenkins</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="main-sidebar rmt-75">
                            <div class="widget widget-search" data-aos="fade-up" data-aos-delay="50"
                            ...
                            <div class="widget widget-category" data-aos="fade-up" data-aos-delay="50"
                                ...
                                <ul>
                                    ...
                                    <li><a href="blog.html">Content Marketing <i class="far fa-arrow-right"></i></a>
                                    </li>
                                    <li><a href="blog.html">Keywords Research <i class="far fa-arrow-right"></i></a>
                                    </li>
                                    <li><a href="blog.html">Technical Adult <i class="far fa-arrow-right"></i></a></li>
                                </ul>
                            </div>
                            <div class="widget widget-recent-news" data-aos="fade-up" data-aos-delay="50"
                                data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="widget widget-tag-cloud" data-aos="fade-up" data-aos-delay="50"
                                data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="widget widget-cta" data-aos="fade-up" data-aos-delay="50"
                                data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="bg bgs-cover"
                                    style="background-image: url(assets/images/widget/cta-bg.png);"></div>
                            </div>
                        </div>
                    </div>
                </div>
