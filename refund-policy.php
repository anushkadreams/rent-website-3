...
<head>
    ...
    <title>Refund Policy || Online Rental Agreement</title>
    <?php
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section
            ...
            style="background-image: url(Images/rent-img88.jpg); height: 400px;">
            <div class="container">
                <div
                    class="banner-inner py-4 rpt-60 text-white d-flex flex-column align-items-center justify-content-center">
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Refund
                        Policy</h1>
