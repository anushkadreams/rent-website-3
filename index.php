...
<head>
    ...
    <title>Home || Online Rental Agreement</title>
    <?php
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Hero area start -->
        <section class="hero-area bgs-cover py-150 rpy-150 overlay"
            style="background-image: url(Images/rent-img10.png); padding: 150px 0px !important;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="hero-content text-center text-white">
                            <span class="subtitle-one mb-20 aos-init aos-animate" data-aos="fade-up"
                                data-aos-duration="1500" data-aos-offset="50"><i
                                    class="fas fa-rocket-launch"></i>Trusted by Thousands</span>
                            <h1 data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50"
                                class="aos-init aos-animate">Legal Rent Agreement in Minutes
                            </h1>
                            <div class="hero-btns aos-init aos-animate" data-aos="fade-up" data-aos-delay="400"
                                data-aos-duration="1500" data-aos-offset="50">
                                <a href="create-agreement.php" class="theme-btn">Create Rent Agreement Now <i
        ...
        <section class="about-area-four py-50 rpt-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-four-images rmb-35 aos-init aos-animate" data-aos="fade-left"
                            data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <div class="col-lg-6">
                        <div class="about-four-content mb-20 aos-init aos-animate" data-aos="fade-right"
                            data-aos-duration="1500" data-aos-offset="50">
                            <div class="section-title">
                                <span class="subtitle-two mb-25"><i class="fas fa-play-circle"></i> <span>Who We
                                        Are</span></span>
                            </div>
                            <p>At OnlineRentalAgreement.in, we simplify the rental process with a fast, secure, and
                                fully digital platform to create legally valid rent agreements. Whether you're a
                                landlord, tenant, or NRI, our service ensures compliance and convenience — without the
                                paperwork.</p>

                            <div class="section-title">
                                <span class="subtitle-two mb-25"><i class="fas fa-play-circle"></i> <span>What We
                                        Do</span></span>
                            </div>
                            <ul class="icon-list style-two">
                                <li><i class="fal fa-check"></i> Online rent agreement creation with Aadhaar-based eSign
                                </li>
                                <li><i class="fal fa-check"></i> Customizable, lawyer-approved templates</li>
                                <li><i class="fal fa-check"></i> E-stamping and biometric verification in supported
                                    regions</li>
                                <li><i class="fal fa-check"></i> Service across all major Indian cities and NRI users
                                </li>
                            </ul>
                            <div class="about-four-btns mt-30">
                                <a href="about-us.php" class="theme-btn style-two">Learn More <i
                                        class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <section class="special-features-area py-50 rpt-80 bg-dark">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-12 col-lg-12">
                        <div class="section-title text-center mb-50 aos-init aos-animate" data-aos="fade-up"
                            data-aos-duration="1500" data-aos-offset="50">
                            <span class="subtitle-two mb-25"><i class="fas fa-play-circle"></i> Special Features</span>
                            <h2 class="text-light">Online Learning Designed For Real Life and Growth Your knowledge</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up"
                        data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-six">
                            <div class="icon">
                                <i class="flaticon-open-book"></i>
                            </div>
                            <div class="content">
                                <h5><a href="">E-Stamping Support</a></h5>
                                <p>Integrated for Maharashtra and other states.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="50"
                        data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-six">
                            <div class="icon">
                            ...
                            <div class="content">
                                <h5><a href="">Digital Signature</a></h5>
                                <p>Legally valid, Aadhaar-enabled e-sign.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100"
                        ...
                        <div class="iconic-box style-six">
                            <div class="icon">
                                <i class="flaticon-new-job"></i>
                            </div>
                            <div class="content">
                                <h5><a href="">Custom Clauses</a></h5>
                                <p>Add conditions to protect your interests.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="150"
                        data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-six">
                            <div class="icon">
                                <i class="flaticon-self-development"></i>
                            </div>
                            <div class="content">
                                <h5><a href="">Secure Platform</a>
                                </h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100"
                        ...
                        <div class="iconic-box style-six">
                            ...
                            <div class="content">
                                <h5><a href="">Pan-India Coverage</a></h5>
                                <p>From Mumbai to remote towns, we’ve got you.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="150"
                        ...
                        <div class="iconic-box style-six">
                            ...
                            <div class="content">
                                <h5><a href="">Quick Turnaround</a>
                                </h5>
                                <p>Get your agreement in 10–15 minutes.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <section class="services-area bgp-bottom bgc-navyblue pb-55 rel z-2"
            style="background-image: url(assets/images/backgrounds/wave-shape.png);">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <blockquote class="blockquote-one text-white" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-offset="50">
                            <div class="text">Business consulting involves the provision expert advice and guidance to
                                organizations seeking to improve their performance, solve specific problems, or achieve
                                specific objectives. The primary purpose of business consultants is to leverage their
                                expertise and experience to help clients make informed decisions, develop strategies,
                                and implement</div>
                            <div class="author">
        ...
        <!-- About Area Start -->
        <section class="about-area py-5 py-60">
            <div class="container">
                <div class="row gap-90 align-items-center">
                    <div class="col-lg-6">
                        <div class="about-images my-40" data-aos="fade-left" data-aos-duration="1500"
                            data-aos-offset="50">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content mt-40 rmt-15" data-aos="fade-right" data-aos-duration="1500"
                            data-aos-offset="50">
                            <div class="section-title mb-30">
                                <h2>Discover Our Company's Vision and Commitment to Excellence</h2>
                            </div>
                            <p>Business consulting is a dynamic and multifaceted field that plays a pivotal role in
                                helping organizations thrive in today's competitive landscape. These consulting services
                                are sought after by businesses of all sizes</p>
                            <div class="row pt-30">
                                <div class="col-sm-6">
                                    <div class="counter-item counter-text-wrap counted">
                                        ...
                                        <div class="text">Strategy consultants work closely organizations define their
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="counter-item counter-text-wrap counted">
                                        ...
                                        <div class="text">Financial consultants provides the financial planning,
                                            budgeting</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 col-md-11">
                        <div class="section-title text-center mb-60" data-aos="fade-up" data-aos-duration="1500"
                            ...
                            <p>Sed ut perspiciatis unde omnis iste sit voluptatem accusantium doloremque laudantium rem
                                aperiam eaqups quae ab illo inventore veritatis et quasi architecto </p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-10">
                        <div class="fancy-box" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000"
                            data-aos-offset="50">
                            <div class="image">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-10">
                        <div class="fancy-box" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000"
                            data-aos-offset="50">
                            <div class="image">
        ...
        <section class="cta-area bgs-cover py-130 rpy-100"
            style="background-image: url(assets/images/backgrounds/cta.jpg);">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6 col-lg-8">
                        <div class="cta-content text-white rmb-35" data-aos="fade-left" data-aos-duration="1000"
                            data-aos-offset="50">
                    ...
                    <div class="col-lg-4">
                        <div class="cta-btn text-lg-center text-start ps-lg-0 ps-2" data-aos="zoom-in-right"
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="fancy-box style-two" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-offset="50">
                            <div class="image">
                            ...
                            <div class="content">
                                ...
                                <div class="inner-content"
                                    style="display: block; overflow: hidden; height: 0.0041635px; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">
                                    <a href="service-details.html" class="read-more">Read More <i
                                            class="far fa-arrow-right"></i></a>
                                </div>
                                <div class="bg">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="fancy-box style-two" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="fancy-box style-two" data-aos="fade-up" data-aos-delay="400"
                            data-aos-duration="1000" data-aos-offset="50">
                            <div class="image">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="fancy-box style-two" data-aos="fade-up" data-aos-delay="600"
                            data-aos-duration="1000" data-aos-offset="50">
                            <div class="image">
            ...
            <div class="container">
                <div class="counter-timeline-wrap">
                    <div class="row no-gap justify-content-center">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="counter-timeline-item counter-text-wrap" data-aos="fade-down"
                                data-aos-duration="1000" data-aos-offset="50">
                                <div class="content">
        ...
        <section class="management-area bgp-bottom bgc-navyblue py-60"
            ...
            <div class="container">
                <div class="row gap-110 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="management-images my-40" data-aos="fade-right" data-aos-duration="1500"
                            data-aos-offset="50">
        ...
        <section class="blog-area pb-100 rpb-70">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6 col-sm-10">
                        <div class="blog-item style-two" data-aos="fade-up" data-aos-duration="1000"
                            data-aos-offset="50">
                            <div class="image">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-10">
                        <div class="blog-item style-two" data-aos="fade-up" data-aos-delay="200"
                            data-aos-duration="1000" data-aos-offset="50">
                            <div class="image">
                            ...
                            <div class="content">
                                ...
                                <h5><a href="blog-details.html">Practical Design Tips Guidelines For Beginner
                                        Designers</a></h5>
                                <ul class="blog-meta">
                                    <li><i class="far fa-user-circle"></i> <a href="#">Roger J. Spaulding</a></li>
                                    <li><i class="far fa-comment-lines"></i> <a href="#">Comments(5)</a></li>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-10">
                        <div class="blog-item style-two" data-aos="fade-up" data-aos-delay="400"
                            data-aos-duration="1000" data-aos-offset="50">
                            <div class="image">
        ...
        <section class="client-logo-area pb-90 rpb-65">
            ...
            <div class="client-logo-wrap">
                ...
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000"
                    data-aos-offset="50">
                    <a href="#"><img src="assets/images/client-logos/client-logo-two2.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000"
                    data-aos-offset="50">
                    <a href="#"><img src="assets/images/client-logos/client-logo-two3.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000"
                    data-aos-offset="50">
                    <a href="#"><img src="assets/images/client-logos/client-logo-two4.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000"
                    data-aos-offset="50">
                    <a href="#"><img src="assets/images/client-logos/client-logo-two5.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000"
                    data-aos-offset="50">
                    <a href="#"><img src="assets/images/client-logos/client-logo-two6.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000"
                    data-aos-offset="50">
                    <a href="#"><img src="assets/images/client-logos/client-logo-two7.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="fade-up" data-aos-delay="700" data-aos-duration="1000"
                    data-aos-offset="50">
