...
<head>
    ...
    <title>Become A Reseller || Online Rental Agreement</title>
    <?php
...
<body>
    <div class="page-wrapper">
        ...
        <section
            ...
            style="background-image: url(Images/rent-img92.jpg); height: 400px;">
            <div class="container">
                <div
                    class="banner-inner py-4 rpt-60 text-white d-flex flex-column align-items-center justify-content-center">
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">Become A
                        Reseller</h1>
                    <nav aria-label="breadcrumb d-flex flex-column align-items-center justify-content-center">
                        <ol class="breadcrumb justify-content-center align-itemms-center" data-aos="fade-up"
                            ...
                            <li class="breadcrumb-item active">Become A Reseller</li>
                        </ol>
                    </nav>
                </div>
            </div>
