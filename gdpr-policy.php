...
<head>
    ...
    <title>GDPR Policy || Online Rental Agreement</title>
    <?php
        ...
        <section
            ...
            <div class="container">
                <div
                    ...
                    <h1 class="page-title" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">GDPR Policy
                    </h1>
                    <nav aria-label="breadcrumb d-flex flex-column align-items-center justify-content-center">
                        <ol class="breadcrumb justify-content-center align-itemms-center" data-aos="fade-up"
                            ...
                            <li class="breadcrumb-item active">GDPR Policy</li>
                        </ol>
                    </nav>
                </div>
            </div>
